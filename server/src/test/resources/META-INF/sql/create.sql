...
CREATE TABLE commande(idcommande serial NOT NULL PRIMARY KEY, idUtilisateur integer, prix integer, dateCommande DATE, datearrive DATE, FOREIGN KEY  (idUtilisateur) REFERENCES utilisateur(idUtilisateur) ON DELETE CASCADE ON UPDATE CASCADE);
